...
export const AvatarUploadModal: React.FC<AvatarUploadModalProps> = ({
  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth>
      ...
      <DialogContent>
        <Stack spacing={3} alignItems="center" sx={{ mt: 1 }}>
          <Alert severity="info" sx={{ width: '100%' }}>
            Upload a profile picture. Recommended size: 400x400px. Max file size: 5MB. Formats
          ...
          <Box sx={{ position: 'relative' }}>
            ...
            >
              {!data.preview && !userProfile?.avatar_url && <CameraIcon fontSize="large" />}
            </Avatar>
          </Box>
      ...
      <DialogActions>
        <Button onClick={onClose} variant="outlined" disabled={isUploading || isRemoving}>
          Annuler
        </Button>
        <Button
