...
export const LABELS = {
  ...
  quoteRequests: {
    ...
    subtitle: 'Surveillez et gérez les demandes de devis de service et les interventions en cours.',

    table: {
      title: 'Gestion des demandes de devis',
      subtitle: 'Suivre les demandes de service et les réponses des fournisseurs',
      headers: {
  ...
  financial: {
    ...
    subtitle: 'Analyse consolidée des revenus, dépenses et transactions',

    tabs: {
      overview: "Vue d'ensemble",
      transactions: 'Transactions',
      owners: 'Rapport propriétaires',
    },
    ...
    cards: {
      ...
      totalExpenses: {
        ...
        subtitle: 'Prestations, maintenance, frais',
      },
      netProfit: {
        title: 'Bénéfice Net',
        subtitle: 'Revenus - Dépenses - Commissions',
      },
      activeSubscriptions: {
        title: 'Abonnements Actifs',
        subtitle: 'Propriétaires abonnés',
      },
    },
    ...
    charts: {
      revenueVsExpenses: {
        ...
        subtitle: 'Évolution mensuelle comparée',
      },
      revenueByCategory: {
        title: 'Répartition des Revenus',
        subtitle: 'Par catégorie de source',
      },
    },
    ...
    owners: {
      title: 'Rapport Consolidé par Propriétaire',
      columns: {
    ...
    calculations: {
      commissionRate: 'Commission PJ',
      subscriptionFee: 'Abonnement annuel',
