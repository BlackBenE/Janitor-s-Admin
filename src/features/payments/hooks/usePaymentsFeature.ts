...
/**
 * Hook principal pour la feature Payments - style UserManagement
 * Combine les queries et mutations
 *
 * RENOMMÉ: usePayments → usePaymentsFeature
 * Pour éviter conflit avec /shared/hooks/data/usePayments (cache global)
 */
export const usePaymentsFeature = (options?: {
