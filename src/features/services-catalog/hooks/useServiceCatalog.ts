...
/**
 * Hook principal pour la feature Services Catalog - style UserManagement/Payments
 * Combine les queries et mutations
 *
 * RENOMMÉ: useServices → useServiceCatalog
 * Pour éviter conflit avec /shared/hooks/data/useServices (cache global)
 */
export const useServiceCatalog = (options?: {
