 ...
 */
/**
 * Hook principal pour les demandes de service - style UserManagement/Payments
 * Combine les queries et retourne les données avec filtres
 *
 * RENOMMÉ: useServiceRequests → useServiceRequestsFeature
 * Pour éviter conflit avec /shared/hooks/data/useServiceRequests (cache global)
 */
export const useServiceRequestsFeature = (options?: {
...
export const useServiceRequestsByService = (serviceId: string) => {
  return useServiceRequestsFeature({
