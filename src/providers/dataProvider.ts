import { supabase, supabaseAdmin, type SupabaseClient } from '@/core/config/supabase';
...
export const dataProvider = {
  async getList<T extends TableName>(
    ...
    if (filters) {
      (Object.entries(filters) as [keyof RowType<T>, RowType<T>[keyof RowType<T>]][]).forEach(
        ([key, value]) => {
