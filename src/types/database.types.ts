...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      check_user_not_locked: { Args: never; Returns: boolean }
      cleanup_inactive_push_tokens: { Args: never; Returns: undefined }
      ...
      execute_gdpr_purges: { Args: never; Returns: number }
      ...
      get_user_unread_count: { Args: { user_uuid: string }; Returns: number }
